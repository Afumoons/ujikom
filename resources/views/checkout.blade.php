                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-group mb-4 mb-lg-0">
                                                    ...
                                                    <select class="form-control form-select select2" title="Country">
                            ...
                            <table class="table table-centered mb-0 table-nowrap">
                                ...
                                <tbody>
                                    @foreach ($cart->items as $item)
                                        <tr>
                                            <th scope="row"><img src="{{ $item->extra_info->image ?? '' }}"
                                                    alt="product-img" title="product-img" class="avatar-md"></th>
                                            <td>
                                                <h5 class="font-size-14 text-truncate"><a
                                                        href="{{ route('shop-detail', $item->extra_info->slug) }}"
                                                        class="text-dark">{{ $item->title }}</a></h5>
                                                <p class="text-muted mb-0">{{ 'Rp. ' . $item->price }} x
                                                    {{ $item->quantity }}
                                                </p>
                                            </td>
                                    ...
                                    <tr class="bg-light">
                                        ...
                                        <td>
                                            Rp. {{ $cart->total + $cart->subtotal * 0.1 + 30000 }}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
